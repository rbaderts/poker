...
class Connect1 {
    ...
    constructor(transport1, opts1, nonce){
        ...
        this.echo = opts1.noEcho ? false : undefined;
        this.verbose = opts1.verbose;
        this.pedantic = opts1.pedantic;
        this.tls_required = opts1.tls ? true : undefined;
...
function gf(init) {
    const r = NumArray(16);
    if (init) for(let i1 = 0; i1 < init.length; i1++)r[i1] = init[i1];
    return r;
}
...
export { DebugEvents1 as DebugEvents, Empty1 as Empty, Events1 as Events, JsHeaders1 as JsHeaders };
...
export { deferred1 as deferred, delay1 as delay, extend1 as extend, extractProtocolMessage1 as extractProtocolMessage, render1 as render, timeout1 as timeout };
export { canonicalMIMEHeaderKey1 as canonicalMIMEHeaderKey, headers1 as headers, Match1 as Match, MsgHdrsImpl1 as MsgHdrsImpl };
...
export { isFlowControlMsg1 as isFlowControlMsg, isHeartbeatMsg1 as isHeartbeatMsg, millis1 as millis, nanos1 as nanos };
